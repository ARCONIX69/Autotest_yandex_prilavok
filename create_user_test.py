...
import sender_stand_request_check_list
import data
...
def positive_assert(first_name):
        ...
        user_response = sender_stand_request_check_list.post_new_user(user_body)
...
def negative_assert_symbol(first_name):
    ...
    response = sender_stand_request_check_list.post_new_user(user_body)
